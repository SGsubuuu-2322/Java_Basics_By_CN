...
import java.util.*;
public class P_69_Code_Insertion_Sort {
	...
	public static void main(String[] args) {
		...
		System.out.println("So, your entered array before Insertion Sort is :- ");
		printArray(arr);
		System.out.println("And, after Insertion Sort, it'll be like :- ");
		insertionSort(arr);
		printArray(arr);
	}
