...
//to the sum of elements at indices [(i + 1) to (N-1)]. One thing to note here is, the item at the index 'i' is not included in either part.
...
//Hence index 2 is an equilibrium index according to the condition we want to achieve. Mind it that we haven't included the item at index 2, 
//which is 10, to either of the parts.
//
//Similarly, we can see at index 3 and 5, the elements to its left sum up to 15 and 9 respectively and to the right, sum up to 15 and 9 
//respectively either. 
//
...
import java.util.*;
public class P_98_Array_Equilibrium_Index {
	...
	public static void main(String[] args) {
		...
		System.out.println("This is the program for finding and printing the equilibrium index of your entered array...");
		int [] arr = inputArray(ip, 1);
