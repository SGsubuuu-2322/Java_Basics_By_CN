...
//In the given string 'a' is repeated 3 times, 'b' is repeated 2 times, 'c' is repeated 2 times 
//and 'd', 's' and 'a' and occuring 1 time hence no compression for last 3 characters.
//Sample Input 2:
//aaabbcddeeeee
//Sample Output 2:
//a3b2cd2e5
...
import java.util.*;
public class P_96_Compress_the_String {
	
	
	public static void comStr(String str){
		int len = str.length();
		char ch = '*';
		int count = 0;
		for(int i = 0; i < len; i++){
	...
	public static void main(String[] args) {
		...
		System.out.println("This is the program for compressing the string in a certain way :- ");
