...
//
//
//That is, in the sequence if numbers are decreasing, they can start increasing at one point. Thereafter, they cannot decrease at 
//any point further.
...
import java.util.*;
public class P_48_Check_Number_sequence {

	public static void main(String[] args) {
		Scanner ip = new Scanner(System.in);
		System.out.println("This is the program for creating a valid increasing and then decreasing or vice-versa...");
		System.out.println("So, enter how many numbers you want to enter :- ");
		int num = ip.nextInt();
		int [] arr = new int[num];
		System.out.println("Now, enter the numbers with every single line :- ");
		for(int i = 0; i < num; i++){
			arr[i] = ip.nextInt();
		}
		boolean flag = true;
